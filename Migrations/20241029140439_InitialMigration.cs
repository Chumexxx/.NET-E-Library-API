    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Borrowing Record", x => x.BorrowingRecordId);
                    table.ForeignKey(
                        name: "FK_Borrowing Record_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumofBooksAvailable = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowedBooks_Borrowing Record_BorrowingRecordId",
                        column: x => x.BorrowingRecordId,
                        principalTable: "Borrowing Record",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowedBooks_BorrowingRecordId",
                table: "BorrowedBooks",
                column: "BorrowingRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_Borrowing Record_AppUserId",
